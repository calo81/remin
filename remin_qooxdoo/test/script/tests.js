...
var envinfo = {"qx.debug":false,"qx.globalErrorHandling":true,"qx.theme":"remin_qooxdoo.theme.Theme","testrunner.testParts":false};
for (var k in envinfo) qx.$$environment[k] = envinfo[k];

if (!qx.$$libraries) qx.$$libraries = {};
var libinfo = {"__out__":{"sourceUri":"../script"},"qx":{"resourceUri":"../resource","sourceUri":"../script","version":"1.4"},"remin_qooxdoo":{"resourceUri":"../resource","sourceUri":"../script","version":"trunk"},"testrunner":{"resourceUri":"../resource","sourceUri":"../script","version":"trunk"}};
...
},toString:function(){return this.__cg+(this.message?b+this.message:c);
}}});
})();
...
qx.Bootstrap.define(a,{extend:Error,construct:function(c,d){this.__ci=b+(c&&c.message?c.message:c);
...
},members:{__cl:null,__cm:null,__cn:null,__co:null,stringify:function(bb,bc,bd){this.__cl=p;
this.__cm=p;
this.__co=[];

if(qx.lang.Type.isNumber(bd)){var bd=Math.min(10,Math.floor(bd));

for(var i=0;i<bd;i+=1){this.__cm+=O;
}}else if(qx.lang.Type.isString(bd)){if(bd.length>10){bd=bd.slice(0,10);
}this.__cm=bd;
}if(bc&&(qx.lang.Type.isFunction(bc)||qx.lang.Type.isArray(bc))){this.__cn=bc;
}else{this.__cn=null;
}return this.__cp(p,{'':bb});
},__cp:function(be,bf){var bi=this.__cl,bg,bj=bf[be];
if(bj&&qx.lang.Type.isFunction(bj.toJSON)){bj=bj.toJSON(be);
}else if(qx.lang.Type.isDate(bj)){bj=this.dateToJSON(bj);
}if(typeof this.__cn===e){bj=this.__cn.call(bf,be,bj);
}
if(bj===null){return h;
}
if(bj===undefined){return undefined;
}switch(qx.lang.Type.getClass(bj)){case R:return this.__cq(bj);
case B:return isFinite(bj)?String(bj):h;
case Q:return String(bj);
case J:this.__cl+=this.__cm;
bg=[];

if(this.__co.indexOf(bj)!==-1){throw new TypeError(V);
}this.__co.push(bj);
var length=bj.length;

for(var i=0;i<length;i+=1){bg[i]=this.__cp(i,bj)||h;
}this.__co.pop();
if(bg.length===0){var bh=s;
}else if(this.__cl){bh=E+this.__cl+bg.join(Y+this.__cl)+b+bi+l;
}else{bh=N+bg.join(d)+l;
}this.__cl=bi;
return bh;
case z:this.__cl+=this.__cm;
bg=[];

if(this.__co.indexOf(bj)!==-1){throw new TypeError(V);
}this.__co.push(bj);
if(this.__cn&&typeof this.__cn===f){var length=this.__cn.length;

for(var i=0;i<length;i+=1){var k=this.__cn[i];

if(typeof k===W){var v=this.__cp(k,bj);

if(v){bg.push(this.__cq(k)+(this.__cl?g:m)+v);
}}}}else{for(var k in bj){if(Object.hasOwnProperty.call(bj,k)){var v=this.__cp(k,bj);

if(v){bg.push(this.__cq(k)+(this.__cl?g:m)+v);
}}}}this.__co.pop();
if(bg.length===0){var bh=A;
}else if(this.__cl){bh=w+this.__cl+bg.join(Y+this.__cl)+b+bi+S;
...
return typeof bs===e?this.__cr({'':j},p,bs):j;
}throw new SyntaxError(P);
},__cr:function(bu,bv,bw){var bx=bu[bv];

if(bx&&typeof bx===f){for(var k in bx){if(Object.hasOwnProperty.call(bx,k)){var v=this.__cr(bx,k,bw);
...
qx.Class.define(Q,{statics:{__cs:true,__ct:function(bA,bB){var bF=p;

for(var i=1,l=arguments.length;i<l;i++){bF=bF+this.__cu(arguments[i]);
}var bE=p;
...
if(this.__cs){qx.Bootstrap.error(bD);
}
if(qx.Class.isDefined(bh)){var bC=new qx.core.AssertionError(bA,bF);

if(this.__cs){qx.Bootstrap.error("Stack trace: \n"+bC.getStackTrace());
}throw bC;
}else{throw new Error(bD);
}},__cu:function(bG){var bH;
...
},assert:function(bI,bJ){bI==true||this.__ct(bJ||p,O);
},fail:function(bK,bL){var bM=bL?p:D;
this.__ct(bK||p,bM);
},assertTrue:function(bN,bO){(bN===true)||this.__ct(bO||p,u,bN,m);
},assertFalse:function(bP,bQ){(bP===false)||this.__ct(bQ||p,y,bP,m);
},assertEquals:function(bR,bS,bT){bR==bS||this.__ct(bT||p,k,bR,bm,bS,n);
},assertNotEquals:function(bU,bV,bW){bU!=bV||this.__ct(bW||p,k,bU,bq,bV,n);
},assertIdentical:function(bX,bY,ca){bX===bY||this.__ct(ca||p,k,bX,W,bY,n);
},assertNotIdentical:function(cb,cc,cd){cb!==cc||this.__ct(cd||p,k,cb,be,cc,n);
},assertNotUndefined:function(ce,cf){ce!==undefined||this.__ct(cf||p,bo);
},assertUndefined:function(cg,ch){cg===undefined||this.__ct(ch||p,t,cg,o);
},assertNotNull:function(ci,cj){ci!==null||this.__ct(cj||p,B);
},assertNull:function(ck,cl){ck===null||this.__ct(cl||p,F,ck,o);
...
cp.search(cq)>=0||this.__ct(cr||p,J,cp,bf,cq.toString(),n);
},assertArgumentsCount:function(cs,ct,cu,cv){var cw=cs.length;
(cw>=ct&&cw<=cu)||this.__ct(cv||p,M,ct,w,cu,bc,arguments.length,ba);
...
}finally{this.__cs=true;
}
if(cQ==null){this.__ct(cP||p,s);
}cQ instanceof cN||this.__ct(cP||p,L,cN,bv,cQ);

if(cO){this.assertMatch(cQ.toString(),cO,cP);
}},assertInArray:function(cS,cT,cU){cT.indexOf(cS)!==-1||this.__ct(cU||p,bw,cS,bd,cT,m);
...
}}},assertKeyInMap:function(cY,da,db){da[cY]!==undefined||this.__ct(db||p,bw,cY,bg,da,m);
},assertFunction:function(dc,dd){qx.lang.Type.isFunction(dc)||this.__ct(dd||p,H,dc,o);
},assertString:function(de,df){qx.lang.Type.isString(de)||this.__ct(df||p,bp,de,o);
},assertBoolean:function(dg,dh){qx.lang.Type.isBoolean(dg)||this.__ct(dh||p,A,dg,o);
},assertNumber:function(di,dj){(qx.lang.Type.isNumber(di)&&isFinite(di))||this.__ct(dj||p,bi,di,o);
},assertPositiveNumber:function(dk,dl){(qx.lang.Type.isNumber(dk)&&isFinite(dk)&&dk>=0)||this.__ct(dl||p,R,dk,o);
},assertInteger:function(dm,dn){(qx.lang.Type.isNumber(dm)&&isFinite(dm)&&dm%1===0)||this.__ct(dn||p,C,dm,o);
},assertPositiveInteger:function(dp,dq){var dr=(qx.lang.Type.isNumber(dp)&&isFinite(dp)&&dp%1===0&&dp>=0);
dr||this.__ct(dq||p,br,dp,o);
},assertInRange:function(ds,dt,du,dv){(ds>=dt&&ds<=du)||this.__ct(dv||p,qx.lang.String.format(Y,[ds,dt,du]));
},assertObject:function(dw,dx){var dy=dw!==null&&(qx.lang.Type.isObject(dw)||typeof dw===bl);
dy||this.__ct(dx||p,T,(dw),o);
},assertArray:function(dz,dA){qx.lang.Type.isArray(dz)||this.__ct(dA||p,bt,dz,o);
},assertMap:function(dB,dC){qx.lang.Type.isObject(dB)||this.__ct(dC||p,v,dB,o);
},assertRegExp:function(dD,dE){qx.lang.Type.isRegExp(dD)||this.__ct(dE||p,r,dD,o);
},assertType:function(dF,dG,dH){this.assertString(dG,S);
typeof (dF)===dG||this.__ct(dH||p,c,dG,bz,dF,o);
},assertInstance:function(dI,dJ,dK){var dL=dJ.classname||dJ+p;
dI instanceof dJ||this.__ct(dK||p,bk,dL,bz,dI,o);
},assertInterface:function(dM,dN,dO){qx.Class.implementsInterface(dM,dN)||this.__ct(dO||p,x,dM,E,dN,n);
...
}catch(dW){this.__ct(dR||p,d,dP,j,dU.join(h),g,dQ,a);
}var dV=dU[0]==dT[0]&&dU[1]==dT[1]&&dU[2]==dT[2];
dV||this.__ct(dR||p,d,dU,j,dU.join(h),g,dQ,j,dT.join(h),P);
},assertElement:function(dX,dY){!!(dX&&dX.nodeType===1)||this.__ct(dY||p,q,dX,n);
},assertQxObject:function(ea,eb){this.__cv(ea,bu)||this.__ct(eb||p,K,ea,o);
},assertQxWidget:function(ec,ed){this.__cv(ec,z)||this.__ct(ed||p,b,ec,o);
},__cv:function(ee,ef){if(!ee){return false;
...
qx.Bootstrap.define(b,{statics:{setErrorHandler:function(d,e){this.__cw=d||null;
this.__cx=e||window;
{if(d&&window.onerror){var f=qx.Bootstrap.bind(this.__cz,this);

if(this.__cy==null){this.__cy=window.onerror;
}var self=this;
window.onerror=function(g,h,i){self.__cy(g,h,i);
f(g,h,i);
};
}
if(d&&!window.onerror){window.onerror=qx.Bootstrap.bind(this.__cz,this);
}if(this.__cw==null){if(this.__cy!=null){window.onerror=this.__cy;
this.__cy=null;
}else{window.onerror=null;
}}};
},__cz:function(j,k,l){if(this.__cw){this.handleError(new qx.core.WindowError(j,k,l));
return true;
}},observeMethod:function(m){{var self=this;
return function(){if(!self.__cw){return m.apply(this,arguments);
}
try{return m.apply(this,arguments);
}catch(n){self.handleError(new qx.core.GlobalError(n,arguments));
}};
};
},handleError:function(o){if(this.__cw){this.__cw.call(this.__cx,o);
...
qx.Class.define(c,{statics:{__cA:{},getManager:function(d){if(d==null){d=window;
...
},PRIORITY_FIRST:-32000,PRIORITY_NORMAL:0,PRIORITY_LAST:32000,__cB:[],addHandler:function(Q){this.__cB.push(Q);
this.__cB.sort(function(a,b){return a.PRIORITY-b.PRIORITY;
});
},getHandlers:function(){return this.__cB;
},__cC:[],addDispatcher:function(R,S){this.__cC.push(R);
...
this.setTestNamespace(this.__sc());
...
return;
}},__sc:function(){var h=window.location.search;
...
},statics:{__jd:qx.$$resources||{},__je:{}},members:{has:function(r){return !!this.self(arguments).__jd[r];
},getData:function(s){return this.self(arguments).__jd[s]||null;
},getImageWidth:function(t){var u=this.self(arguments).__jd[t];
return u?u[0]:null;
},getImageHeight:function(v){var w=this.self(arguments).__jd[v];
return w?w[1]:null;
},getImageFormat:function(x){var y=this.self(arguments).__jd[x];
return y?y[2]:null;
},isClippedImage:function(z){qx.log.Logger.deprecatedMethodWarning(arguments.callee,h);
var A=this.self(arguments).__jd[z];
return A&&A.length>4&&typeof (A[4])==p&&this.constructor.__jd[A[4]];
},getCombinedFormat:function(B){var E=q;
var D=this.self(arguments).__jd[B];
var C=D&&D.length>4&&typeof (D[4])==p&&this.constructor.__jd[D[4]];

if(C){var G=D[4];
var F=this.constructor.__jd[G];
E=F[2];
}return E;
},toUri:function(H){if(H==null){return H;
}var I=this.self(arguments).__jd[H];
...
if((qx.core.Environment.get(m)==n)&&qx.core.Environment.get(l)){J=this.self(arguments).__je[K];
}return J+qx.$$libraries[K].resourceUri+o+H;
},toDataUri:function(L){var N=this.constructor.__jd[L];
var O=this.constructor.__jd[N[4]];
var P;
...
continue;
}if(S.match(/^\/\//)!=null){Q.__je[U]=window.location.protocol;
}else if(S.match(/^\//)!=null){Q.__je[U]=window.location.protocol+k+window.location.host;
}else if(S.match(/^\.\//)!=null){var R=document.URL;
Q.__je[U]=R.substring(0,R.lastIndexOf(o)+1);
}else if(S.match(/^http/)!=null){Q.__je[U]=q;
}else{var V=window.location.href.indexOf(j);
var T;

if(V==-1){T=window.location.href;
}else{T=window.location.href.substring(0,V);
}Q.__je[U]=T.substring(0,T.lastIndexOf(o)+1);
}}}}}});
})();
...
},members:{$$isString:true,length:0,__jf:null,toString:function(){return this.__jf;
...
this.__jg=c;
this.__jh=d;
},members:{__jg:null,__jh:null,translate:function(){return qx.locale.Manager.getInstance().translate(this.__jg,this.__jh);
}}});
})();
...
this.__ji=qx.$$translations||{};
this.__jj=qx.$$locales||{};
var m=qx.core.Environment.get(j);
var n=qx.core.Environment.get(e);

if(n!==k){m+=l+n;
}this.__jk=m;
this.setLocale(m||this.__jl);
...
}},properties:{locale:{check:b,nullable:true,apply:h,event:g}},members:{__jl:f,__jm:null,__jn:null,__ji:null,__jj:null,__jk:null,getLanguage:function(){return this.__jn;
},getTerritory:function(){return this.getLocale().split(l)[1]||k;
},getAvailableLocales:function(){var C=[];

for(var B in this.__jj){if(B!=this.__jl){C.push(B);
}}return C;
},__jo:function(D){var F;
...
},_applyLocale:function(G,H){this.__jm=G;
this.__jn=this.__jo(G);
},addTranslation:function(I,J){var K=this.__ji;

if(K[I]){for(var L in J){K[I][L]=J[L];
}}else{K[I]=J;
}},addLocale:function(M,N){var O=this.__jj;

if(O[M]){for(var P in N){O[M][P]=N[P];
}}else{O[M]=N;
}},translate:function(Q,R,S){var T=this.__ji;
return this.__jp(T,Q,R,S);
},localize:function(U,V,W){var X=this.__jj;
return this.__jp(X,U,V,W);
},__jp:function(Y,ba,bb,bc){var bd;

if(!Y){return ba;
}
if(bc){var bf=this.__jo(bc);
}else{bc=this.__jm;
bf=this.__jn;
}if(!bd&&Y[bc]){bd=Y[bc][ba];
}if(!bd&&Y[bf]){bd=Y[bf][ba];
}if(!bd&&Y[this.__jl]){bd=Y[this.__jl][ba];
}
if(!bd){bd=ba;
}
...
qx.Class.define(r,{statics:{DEBUG:false,__jq:{},__jr:(qx.core.Environment.get(j)==c)&&qx.core.Environment.get(D)<9,__js:qx.core.Environment.select(j,{"mshtml":{"scale-x":true,"scale-y":true,"scale":true,"no-repeat":true},"default":null}),__jt:{"scale-x":h,"scale-y":h,"scale":h,"repeat":i,"no-repeat":i,"repeat-x":i,"repeat-y":i},update:function(J,K,L,M){var O=this.getTagName(L,K);
...
if(this.__jr){try{J.filters[v].apply();
...
}},getTagName:function(W,X){if((qx.core.Environment.get(j)==c)){if(X&&this.__jr&&this.__js[W]&&qx.lang.String.endsWith(X,F)){return i;
}}return this.__jt[W];
...
var bc;
if(this.__jr&&this.__js[ba]&&bd===q){bc=this.__jw(bb,ba,Y);
}else{if(ba===b){bc=this.__jx(bb,ba,Y);
}else if(ba===d||ba===I){bc=this.__jy(bb,ba,Y);
}else{bc=this.__jB(bb,ba,Y);
}}return bc;
},__ju:function(be,bf,bh){if(be.width==null&&bf!=null){be.width=bf+k;
}
if(be.height==null&&bh!=null){be.height=bh+k;
}return be;
},__jv:function(bi){var bj=qx.util.ResourceManager.getInstance().getImageWidth(bi)||qx.io.ImageLoader.getWidth(bi);
var bk=qx.util.ResourceManager.getInstance().getImageHeight(bi)||qx.io.ImageLoader.getHeight(bi);
return {width:bj,height:bk};
},__jw:function(bl,bm,bn){var bq=this.__jv(bn);
bl=this.__ju(bl,bq.width,bq.height);
var bp=bm==f?E:b;
var bo=C+qx.util.ResourceManager.getInstance().toUri(bn)+s+bp+n;
bl.filter=bo;
bl.backgroundImage=bl.backgroundRepeat=g;
return {style:bl};
},__jx:function(br,bs,bt){var bu=qx.util.ResourceManager.getInstance().toUri(bt);
var bv=this.__jv(bt);
br=this.__ju(br,bv.width,bv.height);
return {src:bu,style:br};
},__jy:function(bw,bx,by){var bz=qx.util.ResourceManager.getInstance();
...
if(bx===d){bw=this.__jz(bw,bD,bE.height);
}else{bw=this.__jA(bw,bD,bE.width);
...
return {src:bA,style:bw};
}},__jz:function(bF,bG,bH){var bI=qx.util.ResourceManager.getInstance().getImageHeight(bG[4]);
...
},__jA:function(bJ,bK,bL){var bM=qx.util.ResourceManager.getInstance().getImageWidth(bK[4]);
...
},__jB:function(bN,bO,bP){var bS=qx.util.ResourceManager.getInstance();
...
}else{bN=this.__ju(bN,ca.width,ca.height);
bN=this.__jC(bN,bP,bO);
return {style:bN};
}},__jC:function(cb,cc,cd){var top=null;
var ch=null;
...
},__jD:function(ci){if(this.DEBUG&&qx.util.ResourceManager.getInstance().has(ci)&&ci.indexOf(H)==-1){if(!this.__jq[ci]){qx.log.Logger.debug("Potential clipped image candidate: "+ci);
this.__jq[ci]=true;
}}},isAlphaImageLoaderEnabled:qx.core.Environment.select(j,{"mshtml":function(){return qx.bom.element.Decoration.__jr;
},"default":function(){return false;
}})}});
})();
(function(){var c="engine.name",b="load",a="qx.io.ImageLoader";
qx.Bootstrap.define(a,{statics:{__jE:{},__jF:{width:null,height:null},__jG:/\.(png|gif|jpg|jpeg|bmp)\b/i,isLoaded:function(d){var e=this.__jE[d];
return !!(e&&e.loaded);
},isFailed:function(f){var g=this.__jE[f];
return !!(g&&g.failed);
},isLoading:function(h){var j=this.__jE[h];
return !!(j&&j.loading);
},getFormat:function(k){var m=this.__jE[k];
return m?m.format:null;
},getSize:function(n){var o=this.__jE[n];
return o?
{width:o.width,height:o.height}:this.__jF;
},getWidth:function(p){var q=this.__jE[p];
return q?q.width:null;
},getHeight:function(r){var s=this.__jE[r];
return s?s.height:null;
},load:function(t,u,v){var w=this.__jE[t];
...
var x=qx.lang.Function.listener(this.__jH,this,y,t);
y.onload=x;
y.onerror=x;
y.src=t;
w.element=y;
}},abort:function(z){var A=this.__jE[z];
...
},__jH:qx.event.GlobalError.observeMethod(function(event,D,E){var F=this.__jE[E];

if(!F){}if(event.type===b){F.loaded=true;
F.width=this.__jI(D);
F.height=this.__jJ(D);
var G=this.__jG.exec(E);
...
}}),__jI:qx.core.Environment.select(c,{"gecko":function(I){return I.naturalWidth;
},"default":function(J){return J.width;
}}),__jJ:qx.core.Environment.select(c,{"gecko":function(K){return K.naturalHeight;
...
qx.Class.define(g,{statics:{__jK:[n,null,m,i,null,r,k,null,r],__jL:{backgroundImage:null,backgroundPosition:null,backgroundRepeat:null},__jM:function(v,top){var w=qx.core.Environment.get(d);
...
},__jN:function(A){var String=qx.lang.String;
var B=A.substr(0,50);
return String.startsWith(B,c)&&String.contains(B,a);
},compile:function(C,D,E,top){var F=this.__jM(E,top);
var G=qx.util.ResourceManager.getInstance().toUri(C);

if(this.__jN(G)){G=q+G+q;
}var H=this.__jK;
H[1]=G;
H[4]=F;
H[7]=D;
return H.join(l);
},getStyles:function(I,J,K,top){if(!I){return this.__jL;
}var L=this.__jM(K,top);
var N=qx.util.ResourceManager.getInstance().toUri(I);
var O;

if(this.__jN(N)){O=j+N+p;
}else{O=f+N+e;
...
(function(){var j="nonScaled",i="scaled",h="alphaScaled",g=".png",f="div",e="replacement",d="qx.event.type.Event",c="engine.name",b="hidden",a="Boolean",y="px",x="scale",w="changeSource",v="qx.ui.basic.Image",u="loaded",t="-disabled.$1",s="loadingFailed",r="String",q="_applySource",p="img",n="image",o="mshtml",l="__jO",m="_applyScale",k="no-repeat";
qx.Class.define(v,{extend:qx.ui.core.Widget,construct:function(z){this.__jO={};
qx.ui.core.Widget.call(this);

if(z){this.setSource(z);
}},properties:{source:{check:r,init:null,nullable:true,event:w,apply:q,themeable:true},scale:{check:a,init:false,themeable:true,apply:m},appearance:{refine:true,init:n},allowShrinkX:{refine:true,init:false},allowShrinkY:{refine:true,init:false},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false}},events:{loadingFailed:d,loaded:d},members:{__jP:null,__jQ:null,__jR:null,__jO:null,getContentElement:function(){return this.__jV();
...
},__jS:function(E){this.__jR=E;
},__jT:function(){if(this.__jR==null){var G=this.getSource();
var F=false;

if(G!=null){F=qx.lang.String.endsWith(G,g);
}
if(this.getScale()&&F&&qx.bom.element.Decoration.isAlphaImageLoaderEnabled()){this.__jR=h;
}else if(this.getScale()){this.__jR=i;
}else{this.__jR=j;
}}return this.__jR;
...
if(this.__jO[L]==null){this.__jO[L]=this.__jU(L);
}return this.__jO[L];
...
}else if(qx.io.ImageLoader.isLoaded(M)){this.__ka(this.getContentElement(),M);
}else{this.__kb(this.getContentElement(),M);
...
this.__ke(bd.getImageWidth(bb),bd.getImageHeight(bb));
},__ka:function(be,bf){var bh=qx.io.ImageLoader;
be.setSource(bf);
var bg=bh.getWidth(bf);
var bi=bh.getHeight(bf);
this.__ke(bg,bi);
},__kb:function(bj,bk){var self;
var bl=qx.io.ImageLoader;
if(!bl.isFailed(bk)){bl.load(bk,this.__kd,this);
}else{if(bj!=null){bj.resetSource();
}}},__kd:function(bm,bn){if(this.$$disposed===true){return;
...
},__ke:function(bo,bp){if(bo!==this.__jP||bp!==this.__jQ){this.__jP=bo;
this.__jQ=bp;
qx.ui.core.queue.Layout.add(this);
...
(function(){var o="top",n="right",m="bottom",l="left",k="align-start",j="qx.util.placement.AbstractAxis",i="edge-start",h="align-end",g="edge-end",f="-",c="best-fit",e="qx.util.placement.Placement",d="keep-align",b="direct",a='__kg';
qx.Class.define(e,{extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__kg=new qx.util.placement.DirectAxis();
},properties:{axisX:{check:j},axisY:{check:j},edge:{check:[o,n,m,l],init:o},align:{check:[o,n,m,l],init:n}},statics:{__kh:null,compute:function(p,q,r,s,t,u,v){this.__kh=this.__kh||new qx.util.placement.Placement();
var y=t.split(f);
var x=y[0];
var w=y[1];
this.__kh.set({axisX:this.__kl(u),axisY:this.__kl(v),edge:x,align:w});
return this.__kh.compute(p,q,r,s);
},__ki:null,__kj:null,__kk:null,__kl:function(z){switch(z){case b:this.__ki=this.__ki||new qx.util.placement.DirectAxis();
return this.__ki;
case d:this.__kj=this.__kj||new qx.util.placement.KeepAlignAxis();
return this.__kj;
case c:this.__kk=this.__kk||new qx.util.placement.BestFitAxis();
return this.__kk;
default:throw new Error("Invalid 'mode' argument!'");
}}},members:{__kg:null,compute:function(A,B,C,D){var E=this.getAxisX()||this.__kg;
var G=E.computeStart(A.width,{start:C.left,end:C.right},{start:D.left,end:D.right},B.width,this.__km());
var F=this.getAxisY()||this.__kg;
var top=F.computeStart(A.height,{start:C.top,end:C.bottom},{start:D.top,end:D.bottom},B.height,this.__kn());
return {left:G,top:top};
},__km:function(){var I=this.getEdge();
var H=this.getAlign();
...
}},__kn:function(){var K=this.getEdge();
var J=this.getAlign();
...
(function(){var f="mousedown",d="__ko",c="blur",b="singleton",a="qx.ui.popup.Manager";
qx.Class.define(a,{type:b,extend:qx.core.Object,construct:function(){qx.core.Object.call(this);
this.__ko=[];
qx.event.Registration.addListener(document.documentElement,f,this.__kq,this,true);
qx.bom.Element.addListener(window,c,this.hideAll,this);
},members:{__ko:null,add:function(g){this.__ko.push(g);
this.__kp();
},remove:function(h){if(this.__ko){qx.lang.Array.remove(this.__ko,h);
this.__kp();
...
}}},__kp:function(){var m=1e7;

for(var i=0;i<this.__ko.length;i++){this.__ko[i].setZIndex(m++);
}},__kq:function(e){var o=qx.ui.core.Widget.getWidgetByElement(e.getTarget());
var p=this.__ko;
...
}}},destruct:function(){qx.event.Registration.removeListener(document.documentElement,f,this.__kq,this,true);
this._disposeArray(d);
}});
})();
(function(){var b="abstract",a="qx.ui.layout.Abstract";
qx.Class.define(a,{type:b,extend:qx.core.Object,members:{__jb:null,_invalidChildrenCache:null,__jc:null,invalidateLayoutCache:function(){this.__jb=null;
},renderLayout:function(c,d){this.warn("Missing renderLayout() implementation!");
},getSizeHint:function(){if(this.__jb){return this.__jb;
}return this.__jb=this._computeSizeHint();
},hasHeightForWidth:function(){return false;
},getHeightForWidth:function(e){this.warn("Missing getHeightForWidth() implementation!");
return null;
},_computeSizeHint:function(){return null;
},invalidateChildrenCache:function(){this._invalidChildrenCache=true;
},verifyLayoutProperty:null,_clearSeparators:function(){var f=this.__jc;

if(f instanceof qx.ui.core.LayoutItem){f.clearSeparators();
}},_renderSeparator:function(g,h){this.__jc.renderSeparator(g,h);
},connectToWidget:function(i){if(i&&this.__jc){throw new Error("It is not possible to manually set the connected widget.");
}this.__jc=i;
this.invalidateChildrenCache();
},_getWidget:function(){return this.__jc;
},_applyLayoutChange:function(){if(this.__jc){this.__jc.scheduleLayoutUpdate();
}},_getLayoutChildren:function(){return this.__jc.getLayoutChildren();
}},destruct:function(){this.__jc=this.__jb=null;
}});
})();
...
}},properties:{rich:{check:j,init:false,event:p,apply:n},wrap:{check:j,init:true,apply:a},value:{check:u,apply:x,event:D,nullable:true},buddy:{check:d,apply:v,nullable:true,init:null,dereference:true},textAlign:{check:[m,w,s],nullable:true,themeable:true,apply:f,event:b},appearance:{refine:true,init:l},selectable:{refine:true,init:false},allowGrowX:{refine:true,init:false},allowGrowY:{refine:true,init:false},allowShrinkY:{refine:true,init:false}},members:{__kr:null,__ks:null,__kt:null,__ku:null,_getContentHint:function(){if(this.__ks){this.__kv=this.__kw();
delete this.__ks;
...
}},__kv:{width:0,height:0},_applyFont:function(L,M){var N;

if(L){this.__kr=qx.theme.manager.Font.getInstance().resolve(L);
N=this.__kr.getStyles();
}else{this.__kr=null;
...
var Q=this.getFont();
var P=Q?this.__kr.getStyles():qx.bom.Font.getDefaultStyles();
...
}if(this.__kt!=null){var bc=this.getBuddy();

if(bc!=null&&!bc.isDisposed()){bc.removeBinding(this.__kt);
}}this.__kr=this.__kt=null;
}});
})();
(function(){var b="value",a="qx.html.Label";
qx.Class.define(a,{extend:qx.html.Element,members:{__kx:null,_applyProperty:function(name,c){qx.html.Element.prototype._applyProperty.call(this,name,c);

if(name==b){var d=this.getDomElement();
qx.bom.Label.setValue(d,c);
}},_createDomElement:function(){var f=this.__kx;
...
qx.Class.define(p,{statics:{__ky:{fontFamily:1,fontSize:1,fontWeight:1,fontStyle:1,lineHeight:1},__kz:function(){var F=this.__kB(false);
document.body.insertBefore(F,document.body.firstChild);
return this._textElement=F;
},__kA:function(){var G=this.__kB(true);
document.body.insertBefore(G,document.body.firstChild);
return this._htmlElement=G;
},__kB:function(H){var I=qx.bom.Element.create(h);
var J=I.style;
J.width=J.height=D;
J.left=J.top=t;
J.visibility=b;
...
for(var L in this.__ky){J[L]=g;
}I.appendChild(K);
}}return I;
},__kC:function(M){var N={};
...
R.maxWidth=r;
R.padding=C;
for(var T in this.__ky){S.style[T]=g;
}S.setAttribute(w,q);
Q.appendChild(S);
}else{var Q=P.document.createElement(h);
qx.bom.element.Style.setStyles(Q,this.__kC(O));
}
...
}},getHtmlSize:function(content,X,Y){var ba=this._htmlElement||this.__kA();
ba.style.width=Y!==undefined?Y+x:D;
ba.innerHTML=content;
return this.__kD(ba,X);
},getTextSize:function(bb,bc){var bd=this._textElement||this.__kz();
...
}return this.__kD(bd,bc);
},__kD:function(be,bf){var bg=this.__ky;
...
},__kE:{visible:true,hidden:true},getContentWidth:function(r){var s=qx.bom.element.Style;
var t=qx.bom.element.Overflow.getX(r);
var u=parseInt(s.get(r,d)||i,10);
var x=parseInt(s.get(r,e)||i,10);

if(this.__kE[t]){var w=r.clientWidth;
...
if(this.__kE[C]){return y.clientHeight-B-A;
...
(function(){var i="qx.ui.window.Window",h="changeModal",g="changeVisibility",f="changeActive",d="_applyActiveWindow",c="__kG",b="__kF",a="qx.ui.window.MDesktop";
qx.Mixin.define(a,{properties:{activeWindow:{check:i,apply:d,init:null,nullable:true}},members:{__kF:null,__kG:null,getWindowManager:function(){if(!this.__kG){this.setWindowManager(new qx.ui.window.Window.DEFAULT_MANAGER_CLASS());
}return this.__kG;
},supportsMaximize:function(){return true;
},setWindowManager:function(j){if(this.__kG){this.__kG.setDesktop(null);
}j.setDesktop(this);
this.__kG=j;
...
this.getWindowManager().updateStack();
},getWindows:function(){if(!this.__kF){this.__kF=[];
}return this.__kF;
}},destruct:function(){this._disposeArray(b);
this._disposeObjects(c);
}});
})();
(function(){var f="__kH",e="_applyBlockerColor",d="Number",c="qx.ui.core.MBlocker",b="_applyBlockerOpacity",a="Color";
qx.Mixin.define(c,{construct:function(){this.__kH=new qx.ui.core.Blocker(this);
},properties:{blockerColor:{check:a,init:null,nullable:true,apply:e,themeable:true},blockerOpacity:{check:d,init:1,apply:b,themeable:true}},members:{__kH:null,_applyBlockerColor:function(g,h){this.__kH.setColor(g);
},_applyBlockerOpacity:function(i,j){this.__kH.setOpacity(i);
},block:function(){this.__kH.block();
},isBlocked:function(){return this.__kH.isBlocked();
},unblock:function(){this.__kH.unblock();
},forceUnblock:function(){this.__kH.forceUnblock();
},blockContent:function(k){this.__kH.blockContent(k);
},isContentBlocked:function(){return this.__kH.isContentBlocked();
},unblockContent:function(){this.__kH.unblockContent();
},forceUnblockContent:function(){this.__kH.forceUnblockContent();
},getBlocker:function(){return this.__kH;
...
qx.ui.core.queue.Visibility.add(this);
this.initNativeHelp();
this.addListener(p,this.__kJ,this);
},properties:{appearance:{refine:true,init:n},enabled:{refine:true,init:true},focusable:{refine:true,init:true},globalCursor:{check:i,nullable:true,themeable:true,apply:d,event:q},nativeContextMenu:{refine:true,init:false},nativeHelp:{check:o,init:false,apply:h}},members:{__kI:null,isRootWidget:function(){return true;
},getLayout:function(){return this._getLayout();
},_applyGlobalCursor:qx.core.Environment.select(t,{"mshtml":function(u,v){},"default":function(w,x){var y=qx.bom.Stylesheet;
var z=this.__kI;

if(!z){this.__kI=z=y.createElement();
}y.removeAllRules(z);
...
},__kJ:function(e){if(e.getKeyIdentifier()!==j){return;
}var D=e.getTarget();
...
}},"default":function(){}})},destruct:function(){this.__kI=null;
},defer:function(H,I){qx.ui.core.MChildrenHandling.remap(I);
}});
})();
...
qx.Class.define(g,{extend:qx.ui.root.Abstract,construct:function(o){this.__kK=qx.dom.Node.getWindow(o);
this.__kL=o;
qx.ui.root.Abstract.call(this);
qx.event.Registration.addListener(this.__kK,n,this._onResize,this);
this._setLayout(new qx.ui.layout.Canvas());
qx.ui.core.queue.Layout.add(this);
qx.ui.core.FocusHandler.getInstance().connectTo(this);
this.getContentElement().disableScrolling();
},members:{__kK:null,__kL:null,_createContainerElement:function(){var p=this.__kL;
...
},_computeSizeHint:function(){var u=qx.bom.Viewport.getWidth(this.__kK);
var v=qx.bom.Viewport.getHeight(this.__kK);
...
(function(){var l="zIndex",k="px",j="keydown",h="deactivate",g="resize",f="keyup",d="keypress",c="__kR",b="backgroundColor",a="_applyOpacity",x="Boolean",w="opacity",v="interval",u="Tab",t="__kT",s="__kP",r="Color",q="qx.ui.root.Page",p="Number",o="qx.ui.core.Blocker",m="qx.ui.root.Application",n="_applyColor";
...
if(this._isPageRoot){y.addListener(g,this.__kU,this);
}
...
this.__kV(b,C);
},_applyOpacity:function(D,E){this.__kV(w,D);
},__kV:function(F,G){var H=[];
this.__kP&&H.push(this.__kP);
this.__kR&&H.push(this.__kR);
...
this.__kM.push(I.getActive());
this.__kN.push(I.getFocus());

if(this._widget.isFocusable()){this._widget.focus();
}},_restoreActiveWidget:function(){var L=this.__kM.length;

if(L>0){var K=this.__kM[L-1];

if(K){qx.bom.Element.activate(K);
}this.__kM.pop();
}var J=this.__kN.length;

if(J>0){var K=this.__kN[J-1];

if(K){qx.bom.Element.focus(this.__kN[J-1]);
}this.__kN.pop();
}},__kW:function(){return new qx.html.Blocker(this.getColor(),this.getOpacity());
},getBlockerElement:function(){if(!this.__kP){this.__kP=this.__kW();
this.__kP.setStyle(l,15);
this._widget.getContainerElement().add(this.__kP);
this.__kP.exclude();
}return this.__kP;
},block:function(){this.__kQ++;

if(this.__kQ<2){this._backupActiveWidget();
var M=this.getBlockerElement();
M.include();
M.activate();
M.addListener(h,this.__lc,this);
M.addListener(d,this.__lb,this);
M.addListener(j,this.__lb,this);
M.addListener(f,this.__lb,this);
}},isBlocked:function(){return this.__kQ>0;
},unblock:function(){if(!this.isBlocked()){return;
}this.__kQ--;

if(this.__kQ<1){this.__kX();
this.__kQ=0;
}},forceUnblock:function(){if(!this.isBlocked()){return;
}this.__kQ=0;
this.__kX();
},__kX:function(){this._restoreActiveWidget();
var N=this.getBlockerElement();
N.removeListener(h,this.__lc,this);
N.removeListener(d,this.__lb,this);
N.removeListener(j,this.__lb,this);
N.removeListener(f,this.__lb,this);
N.exclude();
},getContentBlockerElement:function(){if(!this.__kR){this.__kR=this.__kW();
this._widget.getContentElement().add(this.__kR);
this.__kR.exclude();
}return this.__kR;
...
if(this.__kO.length<2){P.include();

if(this._isPageRoot){if(!this.__kT){this.__kT=new qx.event.Timer(300);
this.__kT.addListener(v,this.__la,this);
}this.__kT.start();
this.__la();
}}},isContentBlocked:function(){return this.__kO.length>0;
},unblockContent:function(){if(!this.isContentBlocked()){return;
}this.__kO.pop();
var Q=this.__kO[this.__kO.length-1];
var R=this.getContentBlockerElement();
R.setStyle(l,Q);

if(this.__kO.length<1){this.__kY();
this.__kO=[];
...
S.setStyle(l,null);
this.__kY();
},__kY:function(){this.getContentBlockerElement().exclude();

if(this._isPageRoot){this.__kT.stop();
}},__la:function(){var T=this._widget.getContainerElement().getDomElement();
...
},__lb:function(e){if(e.getKeyIdentifier()==u){e.stop();
}},__lc:function(){if(this.getKeepBlockerActive()){this.getBlockerElement().activate();
}}},destruct:function(){if(this._isPageRoot){this._widget.removeListener(g,this.__kU,this);
}this._disposeObjects(c,s,t);
this.__kS=this.__kM=this.__kN=this._widget=this.__kO=null;
}});
})();
...
this.addListener(t,this.__ld,this);
this.addListener(n,this.__ld,this);
},members:{_stopPropagation:function(e){e.stopPropagation();
},__ld:function(){var A=this.getStyle(k);
this.setStyle(k,null,true);
this.setStyle(k,A,true);
}}});
})();
(function(){var k="keypress",j="focusout",h="activate",g="Tab",f="singleton",d="deactivate",c="__le",b="focusin",a="qx.ui.core.FocusHandler";
qx.Class.define(a,{extend:qx.core.Object,type:f,construct:function(){qx.core.Object.call(this);
this.__le={};
},members:{__le:null,__lf:null,__lg:null,__lh:null,connectTo:function(m){m.addListener(k,this.__li,this);
...
},addRoot:function(n){this.__le[n.$$hash]=n;
},removeRoot:function(o){delete this.__le[o.$$hash];
},getActiveWidget:function(){return this.__lf;
},isActive:function(p){return this.__lf==p;
},getFocusedWidget:function(){return this.__lg;
},isFocused:function(q){return this.__lg==q;
},isFocusRoot:function(r){return !!this.__le[r.$$hash];
},_onActivate:function(e){var t=e.getTarget();
this.__lf=t;
var s=this.__lj(t);

if(s!=this.__lh){this.__lh=s;
}},_onDeactivate:function(e){var u=e.getTarget();

if(this.__lf==u){this.__lf=null;
}},_onFocusIn:function(e){var v=e.getTarget();

if(v!=this.__lg){this.__lg=v;
v.visualizeFocus();
}},_onFocusOut:function(e){var w=e.getTarget();

if(w==this.__lg){this.__lg=null;
w.visualizeBlur();
}},__li:function(e){if(e.getKeyIdentifier()!=g){return;
}
if(!this.__lh){return;
}e.stopPropagation();
e.preventDefault();
...
if(!e.isShiftPressed()){var y=x?this.__ln(x):this.__ll();
}else{var y=x?this.__lo(x):this.__lm();
}if(y){y.tabFocus();
}},__lj:function(z){var A=this.__le;

while(z){if(A[z.$$hash]){return z;
}z=z.getLayoutParent();
}return null;
},__lk:function(B,C){if(B===C){return 0;
...
},__ll:function(){return this.__lr(this.__lh,null);
},__lm:function(){return this.__ls(this.__lh,null);
},__ln:function(M){var N=this.__lh;

if(N==M){return this.__ll();
}
...
O.sort(this.__lk);
var P=O.length;
return P>0?O[0]:this.__ll();
},__lo:function(Q){var R=this.__lh;

if(R==Q){return this.__lm();
}
...
S.sort(this.__lk);
var T=S.length;
return T>0?S[T-1]:this.__lm();
},__lp:function(parent,U,V){var W=parent.getLayoutChildren();
var X;

for(var i=0,l=W.length;i<l;i++){X=W[i];
if(!(X instanceof qx.ui.core.Widget)){continue;
}
if(!this.isFocusRoot(X)&&X.isEnabled()&&X.isVisible()){if(X.isTabable()&&this.__lk(U,X)<0){V.push(X);
}this.__lp(X,U,V);
}}},__lq:function(parent,Y,ba){var bb=parent.getLayoutChildren();
var bc;

for(var i=0,l=bb.length;i<l;i++){bc=bb[i];
if(!(bc instanceof qx.ui.core.Widget)){continue;
}
if(!this.isFocusRoot(bc)&&bc.isEnabled()&&bc.isVisible()){if(bc.isTabable()&&this.__lk(Y,bc)>0){ba.push(bc);
}this.__lq(bc,Y,ba);
}}},__lr:function(parent,bd){var be=parent.getLayoutChildren();
var bf;

for(var i=0,l=be.length;i<l;i++){bf=be[i];
if(!(bf instanceof qx.ui.core.Widget)){continue;
}if(!this.isFocusRoot(bf)&&bf.isEnabled()&&bf.isVisible()){if(bf.isTabable()){if(bd==null||this.__lk(bf,bd)<0){bd=bf;
}}bd=this.__lr(bf,bd);
}}return bd;
},__ls:function(parent,bg){var bh=parent.getLayoutChildren();
var bi;

for(var i=0,l=bh.length;i<l;i++){bi=bh[i];
if(!(bi instanceof qx.ui.core.Widget)){continue;
}if(!this.isFocusRoot(bi)&&bi.isEnabled()&&bi.isVisible()){if(bi.isTabable()){if(bg==null||this.__lk(bi,bg)>0){bg=bi;
}}bg=this.__ls(bi,bg);
}}return bg;
}},destruct:function(){this._disposeMap(c);
this.__lg=this.__lf=this.__lh=null;
}});
})();
...
this.__lu=X;
this.__lv=X.childNodes[1];
this.__lw=X.childNodes[2].firstChild;
this.__lB();
qx.log.Logger.register(this);
qx.core.ObjectRegistry.register(this);
},dispose:function(){qx.event.Registration.removeListener(document.documentElement,g,this.__lC,this);
qx.log.Logger.unregister(this);
},clear:function(){this.__lv.innerHTML=k;
},process:function(bb){this.__lv.appendChild(qx.log.appender.Util.toHtml(bb));
this.__lx();
},__lx:function(){this.__lv.scrollTop=this.__lv.scrollHeight;
},__ly:true,toggle:function(){if(!this.__lu){this.init();
}else if(this.__lu.style.display==h){this.show();
}else{this.__lu.style.display=h;
}},show:function(){if(!this.__lu){this.init();
}else{this.__lu.style.display=K;
this.__lv.scrollTop=this.__lv.scrollHeight;
}},__lz:[],execute:function(){var be=this.__lw.value;
...
bc.className=U;
this.__lz.push(be);
this.__lA=this.__lz.length;
this.__lv.appendChild(bc);
this.__lx();
...
}},__lB:function(e){this.__lv.style.height=(this.__lu.clientHeight-this.__lu.firstChild.offsetHeight-this.__lu.lastChild.offsetHeight)+c;
},__lC:function(e){var bh=e.getKeyIdentifier();
if((bh==H)||(bh==p&&e.isCtrlPressed())){this.toggle();
e.preventDefault();
}if(!this.__lu){return;
}if(!qx.dom.Hierarchy.contains(this.__lu,e.getTarget())){return;
}if(bh==d&&this.__lw.value!=k){this.execute();
this.__lw.value=k;
}if(bh==i||bh==E){this.__lA+=bh==i?-1:1;
this.__lA=Math.min(Math.max(0,this.__lA),this.__lz.length);
var bg=this.__lz[this.__lA];
this.__lw.value=bg||k;
this.__lw.select();
}}},defer:function(bi){qx.event.Registration.addListener(document.documentElement,g,bi.__lC,bi);
}});
})();
...
},FORMAT_STACK:null,escapeHTML:function(bb){return String(bb).replace(/[<>&"']/g,this.__lt);
},__lt:function(bc){var bd={"<":s,">":F,"&":o,"'":p,'"':u};
return bd[bc]||A;
...
(function(){var c="qx.dev.unit.TestCase",b="qx.debug",a="qx.event.type.Data";
...
(function(){var v="qx.event.type.Data",u="error",t="assertionFailed",s="skip",r="qx.dev.unit.RequirementError",q="failure",p="testrunner.unit",o="endTest",n="failed",m="Error in asynchronous test",d="qx.dev.unit.TestResult",k="Asynchronous Test Error",g="Error setting up test: ",c="Error tearing down test: ",b="startTest",f="tearDown",e="qx.core.AssertionError",h="resume() called before wait()",a="Timeout reached before resume() was called.",j="wait";
...
},__lX:function(V){V._addedListeners=[];
...
}},__lY:function(bd){if(bd._addedListeners){var be=bd._addedListeners;
...
this.__ma=[];
},members:{__ma:null,run:function(d,e){var f=c+d.getFullName().replace(/\W/g,b);
this.__ma.push(f);
window[f]=e;
},exportToJsUnit:function(){var self=this;
window.exposeTestFunctionNames=function(){return self.__ma;
};
window.isTestPageLoaded=true;
}}});
})();
(function(){var g="remin_qooxdoo.test.DemoTest",f="This should never fail!",e="A rose by any other name is still a rose",d="Can false be true?!",c="You must be kidding, 3 can never be outside [1,10]!";
qx.Class.define(g,{extend:qx.dev.unit.TestCase,members:{testSimple:function(){this.assertEquals(4,3+1,f);
this.assertFalse(false,d);
},testAdvanced:function(){var a=3;
var b=a;
this.assertIdentical(a,b,e);
...
}},members:{__nV:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__nV;
},getMarkup:function(e){if(this.__nV){return this.__nV;
...
qx.Mixin.define(o,{include:[qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBackgroundImage],construct:function(){this._getDefaultInsetsForBorder=this.__rT;
this._resizeBorder=this.__rS;
this._styleBorder=this.__rQ;
this._generateMarkup=this.__rR;
},properties:{innerWidthTop:{check:f,init:0},innerWidthRight:{check:f,init:0},innerWidthBottom:{check:f,init:0},innerWidthLeft:{check:f,init:0},innerWidth:{group:[w,z,n,k],mode:a},innerColorTop:{nullable:true,check:g},innerColorRight:{nullable:true,check:g},innerColorBottom:{nullable:true,check:g},innerColorLeft:{nullable:true,check:g},innerColor:{group:[u,v,x,r],mode:a}},members:{__rP:null,__rQ:function(D){var E=qx.theme.manager.Color.getInstance();
D.position=t;
...
}},__rR:function(G){var J=this._generateBackgroundMarkup(G);
...
G[y]=0;
G[p]=0;
return this.__rP=this._generateBackgroundMarkup(G,J);
},__rS:function(K,L,M){var N=this.getInsets();
L-=N.left+N.right;
M-=N.top+N.bottom;
...
},__rT:function(){return {top:this.getWidthTop()+this.getInnerWidthTop(),right:this.getWidthRight()+this.getInnerWidthRight(),bottom:this.getWidthBottom()+this.getInnerWidthBottom(),left:this.getWidthLeft()+this.getInnerWidthLeft()};
}}});
})();
...
}},properties:{innerColor:{check:d,nullable:true,apply:i},innerOpacity:{check:o,init:1,apply:i},outerColor:{check:d,nullable:true,apply:i}},members:{__rU:null,_getDefaultInsets:function(){return {top:2,right:2,bottom:2,left:2};
},_isInitialized:function(){return !!this.__rU;
},_applyStyle:function(){},getMarkup:function(){if(this.__rU){return this.__rU;
...
if(qx.ui.decoration.css3.BorderImage.IS_SUPPORTED){this.__rV=new qx.ui.decoration.css3.BorderImage();

if(n){this.__rW(n);
}}else{this.__rV=new qx.ui.decoration.GridDiv(n);
}
if(o!=null){this.__rV.setInsets(o);
}},properties:{baseImage:{check:c,nullable:true,apply:h},insetLeft:{check:m,nullable:true,apply:l},insetRight:{check:m,nullable:true,apply:l},insetBottom:{check:m,nullable:true,apply:l},insetTop:{check:m,nullable:true,apply:l},insets:{group:[i,j,g,a],mode:e}},members:{__rV:null,getMarkup:function(){return this.__rV.getMarkup();
},resize:function(p,q,r){this.__rV.resize(p,q,r);
},tint:function(s,t){},getInsets:function(){return this.__rV.getInsets();
},_applyInsets:function(u,v,name){var w=f+qx.lang.String.firstUp(name);
this.__rV[w](u);
},_applyBaseImage:function(x,y){if(this.__rV instanceof qx.ui.decoration.GridDiv){this.__rV.setBaseImage(x);
}else{this.__rW(x);
}},__rW:function(z){var B,D;
this.__rV.setBorderImage(z);
...
}},statics:{IS_SUPPORTED:qx.bom.element.Style.isPropertySupported("borderImage")},properties:{borderImage:{check:t,nullable:true,apply:j},sliceTop:{check:h,init:0,apply:j},sliceRight:{check:h,init:0,apply:j},sliceBottom:{check:h,init:0,apply:j},sliceLeft:{check:h,init:0,apply:j},slice:{group:[n,v,a,w],mode:c},repeatX:{check:[i,e,d],init:i,apply:j},repeatY:{check:[i,e,d],init:i,apply:j},repeat:{group:[u,m],mode:c}},members:{__rX:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__rX;
},getMarkup:function(){if(this.__rX){return this.__rX;
...
this.__rX=[x,qx.bom.element.Style.compile({"borderImage":o+B+p+C.join(f)+f+D,position:k,lineHeight:0,fontSize:0,overflow:l,boxSizing:r,borderWidth:C.join(b)+g}),y].join(q);
return this.__rX;
...
}},properties:{baseImage:{check:q,nullable:true,apply:s}},members:{__rY:null,__sa:null,__sb:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
...
F.push(a);
return this.__rY=F.join(o);
},resize:function(G,H,I){var J=this.__sb;
...
var Q=S[1];
var P=S[2];
var O=this.__sa={tl:Q+v+P,t:Q+x+P,tr:Q+c+P,bl:Q+p+P,b:Q+r+P,br:Q+y+P,l:Q+b+P,c:Q+n+P,r:Q+u+P};
this.__sb=this._computeEdgeSizes(O);
...
}},destruct:function(){this.__rY=this.__sa=this.__sb=null;
}});
})();
