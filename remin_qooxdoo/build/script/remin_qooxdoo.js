...
var settings = {"qx.application":"remin_qooxdoo.Application","qx.revision":"exported","qx.theme":"remin_qooxdoo.theme.Theme","qx.version":"1.4"};
...
var envinfo = {"qx.application":"remin_qooxdoo.Application","qx.debug":false,"qx.revision":"exported","qx.theme":"remin_qooxdoo.theme.Theme","qx.version":"1.4"};
...
(function(){var l="application/json",k="completed",j="requestLogout",i="editDocument",h="addNewDocument",g="login/session",f="GET",e="login",d="remin_qooxdoo.Application",c="userLogged",a="DELETE",b="documentAdded";
...
var o=new remin_qooxdoo.MainWindow();
var n=new remin_qooxdoo.LoginWindow();
var p=new remin_qooxdoo.DocumentForm();
n.addListener(c,function(){o.openAndFetchDocuments();
n.close();
});
o.addListener(h,function(){p.open();
});
o.addListener(j,function(){var q=new qx.io.remote.Request(g,a,l);
q.addListener(k,function(event){if(event.getContent().ok!=undefined){o.close();
p.close();
n.open();
}},this);
q.send();
});
o.addListener(i,function(event){p.openWithData(event.getData());
}),p.addListener(b,function(){o.openAndFetchDocuments();
p.close();
});
var m=new qx.io.remote.Request(e,f,l);
m.addListener(k,function(event){if(event.getContent().ok!=undefined){o.openAndFetchDocuments();
}else{n.open();
}},this);
m.send();
}}});
...
(function(){var q="icon/16/actions/document-new.png",p="qx.event.type.Event",o="execute",n="requestLogout",m="dblclick",l="document",k="New",j="remin_qooxdoo.MainWindow",i="addNewDocument",h="application/json",c="Collections",g="completed",f="GET",b="remin",a="Logout",e="editDocument",d="qx.event.type.Data";
qx.Class.define(j,{extend:qx.ui.window.Window,construct:function(){qx.ui.window.Window.call(this,b);
...
this.setLayout(t);
t.setColumnWidth(1,600);
var s=new qx.ui.tree.Tree();
s.setWidth(500);
s.setHeight(400);
this.add(s,{row:1,column:0,colSpan:2,rowSpan:2});
var r=new qx.ui.tree.TreeFolder(c);
s.setRoot(r);
r.setOpen(true);
this.tree=s;
},events:{"addNewDocument":p,"editDocument":d,"requestLogout":p},members:{tree:{},addNewDocument:function(){this.fireEvent(i);
},requestLogout:function(){this.fireEvent(n);
},getMenuButton:function(){var toolbar=new qx.ui.toolbar.ToolBar;
toolbar.setWidth(600);
var v=new qx.ui.toolbar.Part;
toolbar.add(v);
var u=new qx.ui.toolbar.Button(k,q,this.__newCommand);
v.add(u);
var w=new qx.ui.toolbar.Button(a,q,this.__newCommand);
v.add(w);
u.addListener(o,this.addNewDocument,this);
w.addListener(o,this.requestLogout,this);
return toolbar;
},populateTree:function(event){theWindow=this;
var x=new Array();
event.getContent().forEach(function(document){if(x[document.category]==null){x[document.category]=new qx.ui.tree.TreeFolder(document.category);
}var z=x[document.category];
var y=new qx.ui.tree.TreeFile(document.name);
theWindow.tree.getRoot().add(z);
var A=document;
z.setOpen(true);
z.add(y);
y.addListener(m,function(){this.fireDataEvent(e,A);
},theWindow);
});
},openAndFetchDocuments:function(){var B=new qx.io.remote.Request(l,f,h);
B.addListener(g,this.populateTree,this);
...
}},members:{__qV:null,_getDefaultInsets:function(){return {top:0,right:0,bottom:0,left:0};
},_isInitialized:function(){return !!this.__qV;
},getMarkup:function(e){if(this.__qV){return this.__qV;
...
qx.Mixin.define(o,{include:[qx.ui.decoration.MSingleBorder,qx.ui.decoration.MBackgroundImage],construct:function(){this._getDefaultInsetsForBorder=this.__rb;
this._resizeBorder=this.__ra;
this._styleBorder=this.__qX;
this._generateMarkup=this.__qY;
},properties:{innerWidthTop:{check:f,init:0},innerWidthRight:{check:f,init:0},innerWidthBottom:{check:f,init:0},innerWidthLeft:{check:f,init:0},innerWidth:{group:[w,z,n,k],mode:a},innerColorTop:{nullable:true,check:g},innerColorRight:{nullable:true,check:g},innerColorBottom:{nullable:true,check:g},innerColorLeft:{nullable:true,check:g},innerColor:{group:[u,v,x,r],mode:a}},members:{__qW:null,__qX:function(D){var E=qx.theme.manager.Color.getInstance();
D.position=t;
...
}},__qY:function(G){var J=this._generateBackgroundMarkup(G);
...
G[y]=0;
G[p]=0;
return this.__qW=this._generateBackgroundMarkup(G,J);
},__ra:function(K,L,M){var N=this.getInsets();
L-=N.left+N.right;
M-=N.top+N.bottom;
...
},__rb:function(){return {top:this.getWidthTop()+this.getInnerWidthTop(),right:this.getWidthRight()+this.getInnerWidthRight(),bottom:this.getWidthBottom()+this.getInnerWidthBottom(),left:this.getWidthLeft()+this.getInnerWidthLeft()};
}}});
})();
